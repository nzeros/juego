...
public class PanelJuegoMejorado extends JPanel implements ActionListener {
    ...
    private void dibujarEscena(Graphics2D g2d) {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            int y = (int)(Math.random() * SUELO_Y);
            g2d.fillOval(x, y, 2, 2);
        }
        
        // Suelo mejorado con textura
    ...
    private void dibujarUIRounds(Graphics2D g2d) {
        // UI Mejorada con efectos y sombras
        g2d.setFont(new Font("Arial", Font.BOLD, 18));
        
        // Panel de información del jugador con sombra
        g2d.setColor(new Color(0, 0, 0, 100));
        g2d.fillRoundRect(12, 12, 220, 98, 10, 10);
        g2d.setColor(new Color(0, 50, 150, 200));
        g2d.fillRoundRect(10, 10, 220, 98, 10, 10);
        g2d.setColor(Color.WHITE);
        g2d.drawRoundRect(10, 10, 220, 98, 10, 10);
        ...
        // Barra de Ki con gradiente azul
        g2d.setColor(Color.BLACK);
        ...
        g2d.setColor(Color.WHITE);
        g2d.drawString("Proyectiles: " + jugador.getProyectiles() + "/" + jugador.getMaxProyectiles(), 15, 90);
        ...
        // Información de rounds en el centro con efectos
        g2d.setFont(new Font("Arial", Font.BOLD, 24));
        g2d.setColor(new Color(0, 0, 0, 150));
        g2d.fillRoundRect(ANCHO/2 - 102, 12, 204, 58, 10, 10);
        g2d.setColor(new Color(100, 100, 100, 200));
        g2d.fillRoundRect(ANCHO/2 - 100, 10, 200, 58, 10, 10);
        g2d.setColor(Color.WHITE);
        g2d.drawRoundRect(ANCHO/2 - 100, 10, 200, 58, 10, 10);
        ...
        // Indicador de puntos por ganar
        String textoPuntos = "Primero en ganar 2 rounds";
        g2d.setFont(new Font("Arial", Font.PLAIN, 12));
        g2d.drawString(textoPuntos, ANCHO/2 - 70, 62);
    }

    private void dibujarInstruccionesCompletas(Graphics2D g2d) {
        g2d.setFont(new Font("Arial", Font.BOLD, 12));
        String instruccion = "Mover: A/D | Saltar: W | Atacar: J | Cargar Ki: S | Súper: K | Proyectil: L";
        
        g2d.setColor(Color.BLACK);
        g2d.drawString(instruccion, 12, ALTO - 15);
        g2d.setColor(Color.WHITE);
        g2d.drawString(instruccion, 10, ALTO - 17);
    }
    ...
    private void dibujarMenu(Graphics2D g2d) { 
        ...
        g2d.drawString("Sistema de 3 Rounds", (ANCHO - fm.stringWidth("Sistema de 3 Rounds")) / 2, 140);
        g2d.setColor(Color.ORANGE);
        g2d.drawString("Con Proyectiles de Energía", (ANCHO - fm.stringWidth("Con Proyectiles de Energía")) / 2, 170);
        g2d.setColor(Color.WHITE);
        g2d.drawString("Selecciona Dificultad", (ANCHO - fm.stringWidth("Selecciona Dificultad")) / 2, 210); 
        
        // Opciones de dificultad con efectos
        for (int i = 0; i < dificultades.length; i++) { 
            if (i == opcionSeleccionada) { 
                g2d.setColor(Color.CYAN); 
                g2d.fillRoundRect((ANCHO - 300) / 2, 280 + i * 40, 300, 30, 10, 10);
                g2d.setColor(Color.BLACK);
                g2d.drawString("> " + dificultades[i].getNombre() + " <", (ANCHO - fm.stringWidth("> " + dificultades[i].getNombre() + " <")) / 2, 300 + i * 40); 
            } else { 
                g2d.setColor(Color.WHITE); 
                g2d.drawString(dificultades[i].getNombre(), (ANCHO - fm.stringWidth(dificultades[i].getNombre())) / 2, 300 + i * 40); 
            } 
    ...
    private void dibujarMensajeRoundEnd(Graphics2D g2d) {
        ...
        String mensaje;
        if (jugador.estaVivo()) {
            mensaje = "¡ROUND GANADO!";
            g2d.setColor(Color.GREEN);
        } else {
            mensaje = "¡ROUND PERDIDO!";
        ...
        // Marcador actual
        g2d.setFont(new Font("Arial", Font.BOLD, 24));
        String marcador = "Marcador: " + victoriasJugador + " - " + victoriasEnemigo;
        g2d.drawString(marcador, (ANCHO - fm.stringWidth(marcador)) / 2, ALTO / 2 + 40);
    }
    ...
    private void dibujarMensajeFinal(Graphics2D g2d, boolean victoria) { 
        ...
        if (victoria) {
            ...
            g2d.drawString("¡Has ganado el torneo!", (ANCHO - fm.stringWidth("¡Has ganado el torneo!")) / 2, ALTO / 2 - 10);
        } else {
            g2d.setColor(Color.RED); 
            g2d.setFont(new Font("Arial", Font.BOLD, 50)); 
            FontMetrics fm = g2d.getFontMetrics(); 
            ...
            g2d.setColor(Color.WHITE);
            g2d.setFont(new Font("Arial", Font.BOLD, 20));
            g2d.drawString("¡Mejor suerte la próxima vez!", (ANCHO - fm.stringWidth("¡Mejor suerte la próxima vez!")) / 2, ALTO / 2 - 10);
        }
        
        g2d.setColor(Color.WHITE); 
        g2d.setFont(new Font("Arial", Font.PLAIN, 20)); 
        FontMetrics fm = g2d.getFontMetrics();
        g2d.drawString("Presiona ENTER para volver al menú", (ANCHO - fm.stringWidth("Presiona ENTER para volver al menú")) / 2, ALTO / 2 + 30); 
        
        // Marcador final
        g2d.setFont(new Font("Arial", Font.BOLD, 24));
        String marcadorFinal = "Resultado Final: " + victoriasJugador + " - " + victoriasEnemigo;
        g2d.drawString(marcadorFinal, (ANCHO - fm.stringWidth(marcadorFinal)) / 2, ALTO / 2 + 70);
    }
} 